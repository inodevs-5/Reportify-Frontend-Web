        ...
        <div className="p-10 flex items-center flex-col">
          {
            ...
            <>
              <h1 className="text-xl">Este site foi desenvolvido para criar o backup do banco de dados de mês em mês automaticamente.</h1>
              <h1 className="text-xl">Porém, o botão abaixo força a criação de um arquivo de backup do banco de dados atual.</h1>
              <button onClick={forceBackup} className='w-40 py-3 rounded-xl text-center  mb-10 mt-5 ring-1 hover:bg-secondary cursor-pointer ring-black-300 shadow-xl' id='botao_backup'>Forçar Backup</button>
              
              <h1 className="text-xl">O botão abaixo proporciona a opção de restauração do banco de dados utilizando </h1>
              <h1 className="text-xl">o último arquivo de backup criado.</h1>
              <button onClick={forceRestore} className='w-40 py-3 rounded-xl text-center  mb-10 mt-5 ring-1 hover:bg-secondary cursor-pointer ring-black-300 shadow-xl' id='botao_restore'>Restaurar Backup</button>
            </>
          }
          <h1 className="text-xl">Tratando-se de segurança de dados dos usuários, nossa empresa se responsabiliza pela utilização</h1>
          <h1 className="text-xl">de tais, tendo portanto um arquivo com termos de compromisso que temos aos nossos clientes</h1>
          <button className='w-40 py-3 rounded-xl text-center  mb-10 mt-5 ring-1 hover:bg-secondary cursor-pointer ring-black-300 shadow-2xl' id='botao_termos'><a href={termoInfo && termoInfo.url}> Termos de Compromisso</a></button>
        </div>
      </div>
    </div>
  );
